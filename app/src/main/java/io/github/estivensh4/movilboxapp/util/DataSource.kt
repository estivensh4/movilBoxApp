...
object DataSource {
    ...
    val productList = listOf(
        ...
        Product(
            id = 9,
            title = "Dell XPS 13",
            description = "The most powerful 13-inch laptop in its class: With up to new 10th Gen Intel Quad Core processors, more cores means increased performance",
            price = 1549,
            discountPercentage = 5.81,
            rating = 4.56,
            stock = 41,
            brand = "Dell",
            category = "laptops",
            ...
            images = listOf(
                ...
                "https://cdn.dummyjson.com/product-images/9/5.jpg",
        ...
        Product(
            id = 10,
            title = "HP Envy 15",
            description = "Premium performance meets remarkable design in a device that commands attention. ",
            price = 1149,
